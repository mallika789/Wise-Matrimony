   	        ...
   	        <div class="col-sm-4 row_2">
				<div class="flexslider">
				  ...
				  <form  action="ImageServlet" method="post" enctype="multipart/form-data">
				  		<h5>Upload Image : </h5> <input type="file"  name="file"  id="file"  required>
     			  </form>			  
			</div>
		    ...
		    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
			   <ul id="myTab" class="nav nav-tabs nav-tabs1" role="tablist">
				  ...
				  <li role="presentation"><a href="#profile1" role="tab" id="profile-tab1" data-toggle="tab" aria-controls="profile1">Partner Preference</a></li>
			   	  <li role="presentation"><a href="Edit" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">Edit Profile</a></li>
			   </ul>
				    	  ...
				    	  <table class="table_working_hours">
				        	<tbody>
							    ...
							    <tr class="opened">
									...
									<td class="day_value closed"><span>Rs. ${userData.annualIncome}</span></td>
								</tr>
							 </tbody>
				          </table>
				         </div>
				...
				<c:forEach var="data" items="${maleUsers}">
					...
					<a href="DisplayById">
						...
						<li class="profile_item-desc">
							...
							<p>${data.getAge()}, ${data.getHeight()}, ${data.getReligion()}</p>
